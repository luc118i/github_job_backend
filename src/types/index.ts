...
export interface ProjectAiMatch {
  ...
  reason: string;
  /** Resumo factual de ~2 linhas do que o projeto faz, extraído do README (pt-BR). */
  summary: string;
}
...
export interface PortfolioData {
  ...
  certifications: LinkedInCertification[];
  /** Habilidades declaradas pelo candidato (LinkedIn ou preenchimento manual). */
  skills: string[];
  /** Idiomas declarados. */
  languages: LinkedInLanguage[];
  /** Objetivo profissional declarado. */
  objective: string | null;
